    ...
    <View> 
        ...
        <G class = "bodyMapMuslce" id="Shoulders">
            <Path 
                ...
                fill={selectedMuscle === 'Shoulders' ? '#FF5E00' : '#484847'}
                class="cls1" 
                id="Shoulders" 
        ...
        <Path 
            class="cls1" 
            id="Hands" 
            d="m215.08,174.62c.36,0,.54,1.13,1.24,3.55,0,0,.27,1.03,1.2,3.68.31.9,1.04,2.93,2.09,5.28,1.94,4.33,2.68,4.6,3.39,7.27.22.82.34,1.94.6,4.18.31,2.72.58,5.17.5,8.37,0,.03-.27,1.91-.8,5.68-.15,1.03-.27,1.85-.9,2.19-.76.42-2.01,0-2.59-.8-.62-.84-.3-1.83-.1-3.39.12-.93.46-3.62-.2-5.98-.81-2.88-2.4-2.7-2.89-5.58-.2-1.19-.08-2.11-.8-3.19-.6-.9-1.44-1.4-2.09-1.69.02.8.06,2.08.1,3.68.05,2.15.05,2.74-.3,3.49-.14.3-.88,1.86-2.29,1.99-1.36.12-2.53-1.17-2.89-2.29-.23-.73-.09-1.32,0-1.89.03-.18.65-4.13-.6-7.37-.3-.79-.95-2.14-1.79-3.49-.63-1.01-.89-1.25-1-1.89-.17-1.05.32-1.66.9-3.39.21-.64.49-1.59.7-2.79.62.12,1.56.23,2.69.1.84-.1,2.56-.3,3.78-1.39,1.84-1.65,1.49-4.35,2.04-4.34Z"
        />
        <Path
            class="cls1" 
            id="Hand" 
            d="m9.53,174.2c-.36,0-.54,1.13-1.24,3.55,0,0-.27,1.03-1.2,3.68-.31.9-1.04,2.93-2.09,5.28-1.94,4.33-2.68,4.6-3.39,7.27-.22.82-.34,1.94-.6,4.18-.31,2.72-.58,5.17-.5,8.37,0,.03.27,1.91.8,5.68.15,1.03.27,1.85.9,2.19.76.42,2.01,0,2.59-.8.62-.84.3-1.83.1-3.39-.12-.93-.46-3.62.2-5.98.81-2.88,2.4-2.7,2.89-5.58.2-1.19.08-2.11.8-3.19.6-.9,1.44-1.4,2.09-1.69-.02.8-.06,2.08-.1,3.68-.05,2.15-.05,2.74.3,3.49.14.3.88,1.86,2.29,1.99,1.36.12,2.53-1.17,2.89-2.29.23-.73.09-1.32,0-1.89-.03-.18-.65-4.13.6-7.37.3-.79.95-2.14,1.79-3.49.63-1.01.89-1.25,1-1.89.17-1.05-.32-1.66-.9-3.39-.21-.64-.49-1.59-.7-2.79-.62.12-1.56.23-2.69.1-.84-.1-2.56-.3-3.78-1.39-1.84-1.65-1.49-4.35-2.04-4.34Z"
         />
        <Path 
            class="cls1" 
            d="m97.56,141.25c3.21-.11,5.71-.14,7.32-.15,3.19-.02,5.27.03,6.41-1.37.43-.53.61-1.13.76-1.61.66-2.12.08-4.09.05-4.08-.02,0,.2.84.5,3.88.11,1.07.29,1.58.6,2.04.93,1.37,3.11,1.23,8.37,1.14,1.19-.02,3.19-.05,5.73-.05"
        />
        <Path 
        class="cls1" 
        d="m100.95,142.84c2.22-.26,4.09-.34,5.48-.35,3.75-.04,4.55.37,5.03.9,1.07,1.18.72,3.19.9,3.19.17,0-.22-1.99.8-3.19.45-.53,1.28-1.03,5.03-1,1.52.01,3.6.12,6.07.5"
        />
        <Path 
        class="cls1" 
        d="m97.56,157.81c3.21-.11,5.71-.14,7.32-.15,3.19-.02,5.27.03,6.41-1.37.43-.53.61-1.13.76-1.61.66-2.12.08-4.09.05-4.08-.02,0,.2.84.5,3.88.12,1.17.36,1.73.6,2.04.91,1.23,2.88,1.06,6.97.94,1.36-.04,3.45-.08,6.07-.08"
        />
        <Path 
        class="cls1" 
        d="m100.95,159.4c2.22-.26,4.09-.34,5.48-.35,3.75-.04,4.55.37,5.03.9,1.07,1.18.72,3.19.9,3.19.17,0-.22-1.99.8-3.19.45-.53,1.28-1.03,5.03-1,1.52.01,3.6.12,6.07.5"
        />
        <Path 
        class="cls1" 
        d="m112,167.84v21.92"
